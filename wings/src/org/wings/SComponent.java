...
public abstract class SComponent
    ...
    private final static Log logger = LogFactory.getLog("org.wings.SComponent");
    ...
    */
    ...
    public void write(Device s) throws IOException {
        try {
            ...
            // Normally we should rethrow this exception, shouldn't we?
            throw ioException;
        }
        catch (Throwable t) {
            logger.warn( "Exception during code generation for " +
                                     getClass().getName(), t);
        }
    }
