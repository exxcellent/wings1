...
public final class Utils implements SConstants
{
   ...
   /** Encolors the actual table cell with the background of the contained component. */
    public static void printTableCellColors(Device s, SComponent c) throws IOException {
       if (c.getBackground() != null || c.getForeground() != null) {
           s.print(" style=\"");
           if (c.getBackground()!=null){
               s.print("background-color:#").print(toColorString(c.getBackground())).print(";");
           }
        ...
        if (fgcolor != null) {
         ...
         if (font != null) {
              ...
              if (font.getFace() != null & font.getSize() > 0) {
                  ...
                  d.print("font-style:").print((style & java.awt.Font.ITALIC) > 0 ? "italic " : "normal ").print(";");
                  d.print("font-weight:").print((style & java.awt.Font.BOLD) > 0 ? "bold " : "normal ").print(";");
                  if (font.getFace() != null) {
                      d.print("font-face:").print(font.getFace()).print("; ");
                  }
                  if (font.getSize() > 0) {
